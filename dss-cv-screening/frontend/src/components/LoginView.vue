    ...
    <div class="w-full max-w-md bg-slate-800 rounded-2xl border border-slate-700/60 shadow-2xl overflow-hidden">
      ...
      <div class="p-8 text-center bg-slate-800/50 border-b border-slate-700/60">
        ...
        <div class="text-center mb-8">
          <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-slate-800 border border-slate-700/60 text-emerald-400 mb-4 shadow-[0_0_30px_-5px_rgba(16,185,129,0.3)] overflow-hidden">
          ...
          <p class="text-sm text-slate-400 mt-2">{{ isRegistering ? 'Buat akun untuk melanjutkan' : 'Masuk ke dashboard panel' }}</p>
        </div>
      </div>
